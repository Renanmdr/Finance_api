...
using Finance.Application.UseCases.Expenses.Reports.Pdf.Colors;
using Finance.Application.UseCases.Expenses.Reports.Pdf.Fonts;
using Finance.Domain.Extensions;
using Finance.Domain.Reports;
...
namespace Finance.Application.UseCases.Expenses.Reports.Pdf;
internal class GenerateExpensesReportPdfUseCase : IGenerateExpensesReportPdfUseCase
{
    ...
    private void CreateHeaderWithProfilePhotoAndName(Section page)
    {
        ...
        row.Cells[1].AddParagraph("Olá, Renan");
